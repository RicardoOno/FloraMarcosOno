...
<div class="container">
    <?php
    $sell = 'Just <b>seedling</b> to sell of Heliamphora.';
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"> <!-- col-md-12 thumbnail -->
                <div class="row"> <!-- row thumbnail -->
                    <div class="col-lg-6 col-md-6  col-sm-6 col-xs-12">
                        <div class="thumbnail ">
                            <img src="../img/biblys.jpg"  data-toggle="modal" data-target=".dio13"  class="img-responsive" alt="Generic placeholder thumbnail">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-3">
                        <div class="thumbnail">
                            <img src="../img/biblys.jpg"  data-toggle="modal" data-target=".dio15"  class="img-responsive" alt="Generic placeholder thumbnail">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-3">
                        <div class="thumbnail">
                            <img src="../img/biblys.jpg"  data-toggle="modal" data-target=".dio16"  class="img-responsive" alt="Generic placeholder thumbnail">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-3">
                        <div class="thumbnail">
                            <img src="../img/biblys.jpg"  data-toggle="modal" data-target=".dio17"  class="img-responsive" alt="Generic placeholder thumbnail">
