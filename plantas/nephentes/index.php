      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12"> <!-- col-md-12 thumbnail -->
          <div class="row"> <!-- row thumbnail -->
            ...
            <div class="col-lg-4 col-md-4  col-sm-4 col-xs-12">
              <div class="thumbnail ">
                <img src="img/"  data-toggle="modal" data-target=".nepxw" class="img-responsive" alt="Generic placeholder thumbnail">
                <div class="modal fade nepxw" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                  <div class="modal-dialog ">
                    <div class="modal-content">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 ">
              <div class="thumbnail ">
                <img src="img/18ventricosa.jpg" data-toggle="modal" data-target=".nepven" class="img-responsive" alt="Generic placeholder thumbnail">
                <div class="modal fade nepven" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      <img src="img/18ventricosa.jpg" class="img-responsive">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;
                      </button>
                    </div>
                  </div>
                ...
                <div class="caption">
                  <h3 class="text-center"> N. Ventricosa</h3>
                  <?php
                  $size1 = 'P';
                  $precop1 = '40,00';
                  $size2 = 'M';
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 ">
              <div class="thumbnail ">
                <img src="img/9arakawaigreen.jpg" data-toggle="modal" data-target=".neparakg" class="img-responsive" alt="Generic placeholder thumbnail">
                <div class="modal fade neparakg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      <img src="img/9arakawaigreen.jpg" class="img-responsive">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;
                      </button>
                    </div>
                  </div>
                ...
                <div class="caption">
                  <h3 class="text-center"> N. Green Arakawai </h3>
                  <?php
                  $size1 = 'P';
                  $precop1 = '40,00';
                  $size2 = 'M';
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 ">
              <div class="thumbnail ">
                <img src="img/16minimaxima.jpg" data-toggle="modal" data-target=".nepminmax" class="img-responsive" alt="Generic placeholder thumbnail">
                <div class="modal fade nepminmax" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      <img src="img/16minimaxima.jpg" class="img-responsive">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;
                      </button>
                    </div>
                  </div>
                ...
                <div class="caption">
                  <h3 class="text-center"> N. Mini Maxima </h3>
                  <?php
                  $size1 = 'P';
                  $precop1 = '40,00';
                  $size2 = 'M';
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 ">
              <div class="thumbnail ">
                <img src="img/7arakawaired.jpg" data-toggle="modal" data-target=".neparak" class="img-responsive" alt="Generic placeholder thumbnail">
                <div class="modal fade neparak" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                  <div class="modal-dialog " id="imgdif">
                    <div class="modal-content">
                      <img src="img/7arakawaired.jpg" class="img-responsive">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;
                      </button>
                    </div>
                  </div>
                ...
                <div class="caption">
                  <h3 class="text-center"> N. Red Arakawai </h3>
                  <?php
                  $size1 = 'P';
                  $precop1 = '40,00';
                  $size2 = 'M';
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 ">
              <div class="thumbnail ">
                <img src="img/10ladypauline-2.jpg" data-toggle="modal" data-target=".neplad" class="img-responsive" alt="Generic placeholder thumbnail">
                <div class="modal fade neplad" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      <img src="img/10ladypauline-2.jpg" class="img-responsive">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;
                      </button>
                    </div>
                  </div>
                ...
                <div class="caption">
                  <h3 class="text-center"> N. Lady Pauline </h3>
                  <?php
                  $size1 = 'P';
                  $precop1 = '40,00';
                  $size2 = 'M';
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 ">
              <div class="thumbnail ">
                <img src="img/12rafflesianaxventricosa.jpg" data-toggle="modal" data-target=".neprxv" class="img-responsive" alt="Generic placeholder thumbnail">
                <div class="modal fade neprxv" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      <img src="img/12rafflesianaxventricosa.jpg" class="img-responsive">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;
                      </button>
                    </div>
                  </div>
                ...
                <div class="caption">
                  <h3 class="text-center"> N. Rafflesiana x Ventricosa </h3>
                  <?php
                  $size1 = 'P';
                  $precop1 = '40,00';
                  $size2 = 'M';
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 ">
              <div class="thumbnail ">
                <img src="img/13sanguinea.jpg" data-toggle="modal" data-target=".nepsan" class="img-responsive" alt="Generic placeholder thumbnail">
                <div class="modal fade nepsan" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      <img src="img/13sanguinea.jpg" class="img-responsive">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;
                      </button>
                    </div>
                  </div>
                ...
                <div class="caption">
                  <h3 class="text-center"> N. Sanguinea </h3>
                  <?php
                  $size1 = 'P';
                  $precop1 = '40,00';
                  $size2 = 'M';
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 ">
              <div class="thumbnail ">
                <img src="img/14sp1-noID.jpg" data-toggle="modal" data-target=".nepwoid " class="img-responsive" alt="Generic placeholder thumbnail">
                <div class="modal fade nepwoid" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      <img src="img/14sp1-noID.jpg" class="img-responsive">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;
                      </button>
                    </div>
                  </div>
                ...
                <div class="caption">
                  <h3 class="text-center"> N. SP1 (w/o ID) </h3>
                  <?php
                  $size1 = 'P';
                  $precop1 = '40,00';
                  $size2 = 'M';
