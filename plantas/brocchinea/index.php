...
<div class="container">
    <?php
    $sell = 'Just <b>seedling</b> to sell of Brocchinea.';
            ...
            <div class="col-md-12 col-sm-12 col-xs-12"> <!-- col-md-12 thumbnail -->
                <div class="row"> <!-- row thumbnail -->
                    <div class="col-lg-6 col-md-6  col-sm-6 col-xs-12">
                        <div class="thumbnail ">
                            <img src="../img/brocchinea.jpg"  data-toggle="modal" data-target=".dio13"  class="img-responsive" alt="Generic placeholder thumbnail">
                            <div class="modal fade dio13" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                                <div class="modal-dialog ">
                                    <div class="modal-content">
                                        <img src="../img/brocchinea.jpg" class="img-responsive">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-3">
                        <div class="thumbnail">
                            <img src="img/brocchinea-1.jpg"  data-toggle="modal" data-target=".dio14"  class="img-responsive" alt="Generic placeholder thumbnail">
                            <div class="modal fade dio14" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                                <div class="modal-dialog ">
                                    <div class="modal-content">
                                        <img src="img/brocchinea-1.jpg" class="img-responsive">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-3">
                        <div class="thumbnail">
                            <img src="img/brocchinea-1.jpg"  data-toggle="modal" data-target=".dio15"  class="img-responsive" alt="Generic placeholder thumbnail">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-3">
                        <div class="thumbnail">
                            <img src="img/brocchinea-1.jpg"  data-toggle="modal" data-target=".dio16"  class="img-responsive" alt="Generic placeholder thumbnail">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-3">
                        <div class="thumbnail">
                            <img src="img/brocchinea-1.jpg"  data-toggle="modal" data-target=".dio17"  class="img-responsive" alt="Generic placeholder thumbnail">
